...
if section == " Project Overview":
    ...
    **Navigation Tips:**  
    ...
    try:
        ...
        # Countplot: Causative Agent (Top-N)
    ...
    try:
        ...
        #normalize the two filter columns if present
